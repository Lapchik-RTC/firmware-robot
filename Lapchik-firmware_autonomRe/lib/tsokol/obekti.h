...
// #include "tsokol/nizhnii_uroven_upravlenia_platformoi/encoder.h"
// #include "nizhnii_uroven_upravlenia_platformoi/encoder.h"
...
class MotorUnit : public EncoderParams
{

...
// void triR(float pos){ serv1.setGoalPos(pos); serv3.setGoalPos(pos); serv4.setGoalPos(pos); }
// void triL(float pos){ serv2.setGoalPos(pos); serv5.setGoalPos(pos); serv6.setGoalPos(pos); }

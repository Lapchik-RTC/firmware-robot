...
#define KOLVO_ENC_TICK_1 1860 // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_2 1860 // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_3 1860 // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_4 1860 // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_5 1860 // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_6 1860 // количество тиков датчика холла на 1 энкодере за 1 полный оборот

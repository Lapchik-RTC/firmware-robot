...
void printPacket2() {
  ...
  if (readPacket()) {
    Serial.println("Valid packet:");
    Serial.print("LeftThumbX: ");
    Serial.print(gamePad.LeftThumbX);
    Serial.print(" LeftThumbY: ");
    Serial.print(gamePad.LeftThumbY);
    if (gamePad.LeftThumbPress) Serial.println("  Левый стик нажат! ");
    else Serial.println("  Левый НЕ стик нажат! ");

    Serial.print("RightThumbX: ");
    Serial.print(gamePad.RightThumbX);
    Serial.print(" RightThumbY: ");
    Serial.print(gamePad.RightThumbY);
...
bool nado_rabotat() {
  ...
  if (
    (gamePad.RightThumbY >= -luft) && (gamePad.RightThumbY <= luft) && (gamePad.RightThumbX >= -luft) && (gamePad.RightThumbX <= luft) && (!gamePad.B) && (!gamePad.A) && (!gamePad.X) && (!gamePad.Y) && (!gamePad.DPad_Up)

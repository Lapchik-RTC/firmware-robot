...
#define KOLVO_ENC_TICK_1  1830/*1755.0*/ // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_4  1830/*1745.0*/ // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_5  1830/*1745.0*/ // количество тиков датчика холла на 1 энкодере за 1 полный оборот

#define KOLVO_ENC_TICK_2  1830/*1750.0*/ // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_3  1830/*1755.0*/ // количество тиков датчика холла на 1 энкодере за 1 полный оборот
#define KOLVO_ENC_TICK_6  1830/*1748.0*/ // количество тиков датчика холла на 1 энкодере за 1 полный оборот
